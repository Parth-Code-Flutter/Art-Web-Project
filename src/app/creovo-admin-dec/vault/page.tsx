                    ...
                    <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4">
                        <div className="relative group w-full md:w-auto">
                            ...
                            <input
                                ...
                                className="bg-zinc-900/50 border border-white/5 rounded-2xl pl-12 pr-4 py-3 w-full md:w-[300px] focus:outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 transition-all placeholder:text-zinc-600 text-sm"
                            />
                        </div>
