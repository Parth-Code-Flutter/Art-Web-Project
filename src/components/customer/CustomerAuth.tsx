                        ...
                        <div className="p-8 md:p-10 relative z-10">
                            ...
                            {(mode === 'login' || (mode === 'register' && step === 1)) && (
                                <div className="space-y-4 mb-8">
                                    <button onClick={handleGoogleLogin} disabled={loading} className="w-full h-12 rounded-2xl border border-white/5 bg-zinc-900/40 hover:bg-zinc-900 transition-all flex items-center justify-center gap-3 group">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-widest text-white">Continue with Google</span>
                                    </button>
                                    <div className="relative flex items-center justify-center group pointer-events-none">
                                        ...
                                        <div className="relative px-4 bg-zinc-950 text-[8px] font-black text-zinc-700 uppercase tracking-widest transition-colors group-hover:text-zinc-500">Or Entry via Email</div>
                                    </div>
                                </div>
                            )}
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                            ...
                                            <>
                                                ...
                                                <div className="space-y-1.5">
                                                    ...
                                                    <div className="relative group">
                                                        ...
                                                        <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} className="w-full bg-zinc-900/50 border border-white/5 rounded-2xl pl-12 pr-12 py-3.5 text-sm text-white focus:outline-none focus:border-white/20" placeholder="••••••••" required />
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="space-y-1.5">
                                                            ...
                                                            <div className="relative group">
                                                                ...
                                                                <input type="text" value={fullName} onChange={(e) => setFullName(e.target.value)} className="w-full bg-zinc-900/50 border border-white/5 rounded-2xl pl-12 pr-4 py-3.5 text-sm text-white focus:outline-none focus:border-white/20" placeholder="Legal or Pen Name" required />
                                                            </div>
                                                        </div>
                                                        <div className="space-y-1.5">
                                                    ...
                                                    <>
                                                        <div className="space-y-1.5">
                                                            ...
                                                            <div className="relative group text-white">
                                                                ...
                                                                <select value={country} onChange={(e) => setCountry(e.target.value)} className="w-full bg-zinc-900/50 border border-white/5 rounded-2xl pl-12 pr-4 py-3.5 text-sm focus:outline-none appearance-none cursor-pointer">
                                ...
                                <div className="flex gap-3 pt-6">
                                    {mode === 'register' && step > 1 && (
                                        <button type="button" onClick={prevStep} className="flex-1 py-4 rounded-2xl border border-white/5 text-zinc-600 font-black uppercase tracking-widest text-[9px] hover:bg-white/5 hover:text-white transition-all">
                                            Return
                                        </button>
                                    )}

                                    {mode === 'register' && step < 3 ? (
                                        <button type="button" onClick={nextStep} className={`flex-[2] py-4 rounded-2xl font-black uppercase tracking-widest text-[9px] transition-all flex items-center justify-center gap-2 ${type === 'seller' ? 'bg-violet-600 text-white' : 'bg-white text-black'}`}>
                                            Next Step <ArrowRight size={14} />
                                        </button>
                                    ) : (
                                        <button type="submit" disabled={loading} className={`flex-[2] py-4 rounded-2xl font-black uppercase tracking-widest text-[9px] transition-all flex items-center justify-center gap-2 ${type === 'seller' ? 'bg-violet-600 text-white disabled:opacity-50' : 'bg-white text-black disabled:opacity-50'}`}>
                            ...
                            <div className="mt-8 text-center space-y-6">
                                <div className="text-[10px] font-black text-zinc-600 hover:text-zinc-500 transition-colors cursor-default">
                                    {mode === 'login' ? (
                                        <p>NEW COLLECTOR? <button onClick={toggleMode} className="text-white hover:underline transition-all underline-offset-4 decoration-zinc-700">JOIN NOW</button></p>
                                    ) : (
                                        <p>ALREADY ENROLLED? <button onClick={toggleMode} className="text-white hover:underline transition-all underline-offset-4 decoration-zinc-700">LOGIN</button></p>
                                    )}
                                </div>
